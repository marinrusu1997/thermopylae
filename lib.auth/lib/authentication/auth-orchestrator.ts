import { AccessTokens, AuthStep } from './auth-step';
...
class AuthOrchestrator {
	...
	public async authenticate(data: AuthNetworkInput, account: Account, session: AuthSession): Promise<string | AccessTokens> {

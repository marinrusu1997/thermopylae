import type { DeviceBase, SessionId, UserSessionMetaData, UserSessionOperationContext } from './session.js';
 ...
 *
 * @throws                 In case some anomalies are detected between read context and session
 *   metadata, an exception should be thrown to stop read operation and mark session access as
 *   invalid.
 */
...
export type { ReadUserSessionHook };

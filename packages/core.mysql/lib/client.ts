...
interface MySQLClientOptions {
	...
	readonly sessionVariablesQueries?: string[];
	/**
 ...
 */
class MySQLClient {
	private connections: ConnectionsManager | null = null;
	...
	public getConnection(type: QueryType): Promise<PoolConnection> {
		return this.connections?.getConnection(type) as Promise<PoolConnection>;
	}

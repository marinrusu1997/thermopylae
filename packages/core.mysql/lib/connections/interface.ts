...
import type { Pool, PoolConnection } from 'mysql2/promise.js';
 ...
 * @private
 */
type PoolConfigurator = (pool: Pool, configOptions: ObjMap) => void;
...
export { QueryType, type PoolConfigurator, type ConnectionsManager };

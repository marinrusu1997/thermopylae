...
interface JwtUserSessionMiddlewareOptions {
	 ...
	 */
	readonly jwt: JwtUserSessionManagerOptions<JwtSessionDevice, HTTPRequestLocation>;
	/**
...
class JwtUserSessionMiddleware {
	...
	private readonly jwtSessionManager: JwtUserSessionManager<JwtSessionDevice, HTTPRequestLocation>;

	public constructor(options: JwtUserSessionMiddlewareOptions) {
		this.options = JwtUserSessionMiddleware.fillWithDefaults(options);
		this.jwtSessionManager = new JwtUserSessionManager<JwtSessionDevice, HTTPRequestLocation>(options.jwt);
	}

	/**
	 * Get {@link JwtUserSessionManager} instance.
	 */
	public get sessionManager(): JwtUserSessionManager<JwtSessionDevice, HTTPRequestLocation> {

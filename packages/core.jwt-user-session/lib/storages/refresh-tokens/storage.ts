...
import type { UserSessionMetaData, UserSessionStorage } from '@thermopylae/lib.user-session.commons';
 ...
 */
class RefreshTokensRedisStorage implements UserSessionStorage<JwtSessionDevice, HTTPRequestLocation> {

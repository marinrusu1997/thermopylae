 ...
 */
type StandardHttpRequestHeaders =
	| 'a-im'
	| 'accept'
	| 'accept-charset'
	| 'accept-datetime'
 ...
 */
type NonStandardHttpRequestHeaders =
 ...
 */
type HttpRequestHeader = StandardHttpRequestHeaders | NonStandardHttpRequestHeaders;
...
export { HttpRequestHeaderEnum };
export type { HttpRequestHeader, NonStandardHttpRequestHeaders, StandardHttpRequestHeaders };

...
/** Mime types that can be used for _Content-Type_ HTTP header. */
enum MimeType {
	/** AAC audio. */
	AAC = 'audio/aac',
	 ...
	 * - [whatwg dependencies willful
	 *   violation](https://html.spec.whatwg.org/multipage/#dependencies:willful-violation)
	 ...
	 * Format](https://acrobat.adobe.com/us/en/acrobat/about-adobe-pdf.html) (PDF)
	 */
	PDF = 'application/pdf',

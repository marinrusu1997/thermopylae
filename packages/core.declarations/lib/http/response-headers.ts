...
export enum HttpResponseHeaderEnum {
	...
	ACCEPT_CH = 'accept-ch',
	/**
	 * Specifying which web sites can participate in [cross-origin resource sharing](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing).
	 */
	...
	/**
	 * What partial content range types this server supports via [byte serving](https://en.wikipedia.org/wiki/Byte_serving).
	 */
	ACCEPT_RANGES = 'accept-ranges',
	/**
	 * The age the object has been in a [proxy cache](https://en.wikipedia.org/wiki/Web_cache) in seconds.
	 */
	AGE = 'age',
	/**
	 ...
	 * can also be accessed at a different network location (host or port) or using a different protocol. <br/>
	...
	/**
	 * Control options for the current connection and list of hop-by-hop response fields. <br/>
	 ...
	 * or suggest a filename for dynamic content. <br/>
	...
	/**
	 * An identifier for a specific version of a resource, often a [message digest](https://en.wikipedia.org/wiki/Cryptographic_hash_function)
	 */
	ETAG = 'etag',
	/**
	 ...
	 * a lot of websites set this field with fake policy text, that was enough to fool browsers the existence

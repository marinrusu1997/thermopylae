 ...
 *
 * > **Important!** The main purpose of this hook is to send a notification to user about this via
...
export type { OnAccountDisabledHook, OnPasswordChangedHook, OnForgottenPasswordChangedHook, OnAuthenticationFromDifferentContextHook };

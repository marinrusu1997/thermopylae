...
interface FailedAuthenticationAttemptsRepository {
	 ...
	 */
	readRange(accountId: string, startingFrom?: UnixTimestamp, endingTo?: UnixTimestamp): Promise<FailedAuthenticationModel[]>;
}
...
interface SuccessfulAuthenticationsRepository {
	 ...
	 */
	readRange(accountId: string, startingFrom?: UnixTimestamp, endingTo?: UnixTimestamp): Promise<SuccessfulAuthenticationModel[]>;

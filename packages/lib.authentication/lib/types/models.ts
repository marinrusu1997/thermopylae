...
/** Model which represents user account. It is managed by {@link AccountRepository}. */
interface AccountModel {
	...
	/**
	 * Account availability status. <br/> Might be enabled, disabled until activation or disabled
	...
	mfa: boolean;
	/** Public Key of the account. <br/> Will be used for different encryption operations. */
	pubKey?: string | null;
}
...
/**
 * Model which represents successful authentication. <br/> Whenever user successfully authenticates,
 * this model will be persisted by the {@link SuccessfulAuthenticationsRepository}.
 */
...
/**
 * Model which represents failed authentication. <br/> Whenever user fails to authenticate too many
 * times and it's account is disabled as consequence, this model will be persisted by the
 * {@link FailedAuthenticationAttemptsRepository}.
 */

...
import { validateSuccessfulLogin } from './utils';
...
describe.only('Authenticate spec', () => {
	...
	it('authenticates successfully', async () => {
		...
		expect(EmailSenderInstance.client.outboxFor(account.id, 'notifyAuthenticationFromDifferentDevice')).to.be.ofSize(0); // first auth evar, trust me

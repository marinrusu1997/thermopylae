import type { PublicPrivateKeys, RequireAtLeastOne, Seconds, Threshold } from '@thermopylae/core.declarations';
import type { UserSessionOptions } from '@thermopylae/core.jwt-session';
import type { DefaultFormatters, GraylogEndpoint, GraylogLoggingChannel, OutputFormat } from '@thermopylae/core.logger';
import type { Argon2PasswordHashingOptions, TotpTwoFactorAuthStrategyOptions } from '@thermopylae/lib.authentication';
...
interface LoggerConfig {
	...
	formatting: {
		...
		skippedFormatters?: (DefaultFormatters.TIMESTAMP | DefaultFormatters.ERRORS | DefaultFormatters.ALIGN | string)[];
	};
}
...
export type { GeoIpConfig, EmailConfig, LoggerConfig, JwtUserSessionMiddlewareConfig, AuthenticationEngineConfig, AppConfig };

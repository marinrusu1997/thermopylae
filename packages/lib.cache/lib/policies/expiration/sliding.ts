...
> extends AbstractExpirationPolicy<Key, Value, ArgumentsBundle> {
	/** @private */
	private readonly gc: GarbageCollector<ExpirableSlidingCacheEntry<Key, Value>>;

	public constructor(gc?: GarbageCollector<ExpirableSlidingCacheEntry<Key, Value>>) {
		super();

		this.gc = gc || new BucketGarbageCollector<ExpirableSlidingCacheEntry<Key, Value>>();

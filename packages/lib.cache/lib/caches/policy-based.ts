...
import { type Cache, CacheEvent, type CacheEventListener } from '../typings/cache.js';
...
class PolicyBasedCache<Key, Value, ArgumentsBundle = unknown> extends EventEmitter implements Cache<Key, Value, ArgumentsBundle> {
	...
	private readonly policies: CacheReplacementPolicy<Key, Value, ArgumentsBundle>[];
	 ...
	 */
	public constructor(backend: CacheBackend<Key, Value>, policies?: CacheReplacementPolicy<Key, Value, ArgumentsBundle>[]) {
		super();

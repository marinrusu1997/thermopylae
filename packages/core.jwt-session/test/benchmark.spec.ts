...
import type { JwtSessionDevice } from '../lib';
import { AVRO_SERIALIZER } from '../lib/storages/refresh-tokens/avro-serializer';
import { JSON_SERIALIZER } from '../lib/storages/refresh-tokens/json-serializer';
import { FAST_JSON_SERIALIZER } from '../lib/storages/refresh-tokens/fast-json-serializer';

const samples: Array<UserSessionMetaData<JwtSessionDevice, HTTPRequestLocation>> = [
	{
		ip: '127.0.0.1',
		device: null,
		location: null,

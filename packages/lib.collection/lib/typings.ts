 ...
 * predicate function.
 */
type Query<Document extends object> = IndexValue | QueryConditions<Document> | UnaryPredicate<Document>;
 ...
 * @inheritdoc {@link FindOptions}
 */
type DeleteOptions<Document> = Omit<FindOptions<Document>, 'sort' | 'projection'>;

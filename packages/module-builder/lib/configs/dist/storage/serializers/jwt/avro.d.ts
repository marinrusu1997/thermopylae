 ...
 * @private
 */
declare const AVRO_SERIALIZER: Readonly<UserSessionMetaDataSerializer<UserSessionMetaData<UserSessionDevice, HTTPRequestLocation>>>;
export { AVRO_SERIALIZER };
//# sourceMappingURL=avro.d.ts.map
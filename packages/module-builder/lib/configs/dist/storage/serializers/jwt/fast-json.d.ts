 ...
 * @private
 */
declare const FAST_JSON_SERIALIZER: Readonly<UserSessionMetaDataSerializer<UserSessionMetaData<UserSessionDevice, HTTPRequestLocation>>>;
export { FAST_JSON_SERIALIZER };
//# sourceMappingURL=fast-json.d.ts.map
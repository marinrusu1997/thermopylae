...
CREATE TABLE IF NOT EXISTS User (
    ...
    RelatedAccountID INT UNSIGNED, -- null means user is inactive -> doesn't have account -> can't log into system
...
CREATE TABLE IF NOT EXISTS Authentication (
    ...
    RelatedAccountID INT UNSIGNED NOT NULL UNIQUE, -- authentication is not standalone, it needs to belong to an account;
...
CREATE TABLE IF NOT EXISTS FailedAuthenticationAttempt (
    ...
    RelatedAuthenticationID INT UNSIGNED NOT NULL, -- obviously it needs to be associated with an authentication

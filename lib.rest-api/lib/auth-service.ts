...
AuthRouter.get('/session', AuthValidator.getActiveSessions, asyncHandler(AuthController.getActiveSessions));
AuthRouter.get(
...
AuthRouter.put('/account/password', asyncHandler(AuthValidator.changePassword), asyncHandler(AuthController.changePassword));

...
async function testPattern(service: Services, method: string, data: object, dataPath: string, pattern: string): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testFormat(service: Services, method: string, data: object, dataPath: string, format: string): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testMinLength(service: Services, method: string, data: object, dataPath: string, length: number): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testMaxLength(service: Services, method: string, data: object, dataPath: string, length: number): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testRequired(service: Services, method: string, data: object, dataPath: string, requiredProperty: string | string[]): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testPassesValidation(service: Services, method: string, data: object): Promise<void> {
	expect(await Firewall.validate(service, method, data)).to.be.deep.eq(data);
}

async function testMinValue(service: Services, method: string, data: object, dataPath: string, value: number): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testEnum(service: Services, method: string, data: object, dataPath: string): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
...
async function testAdditionalProperties(service: Services, method: string, data: object): Promise<void> {
	let err;
	try {
		await Firewall.validate(service, method, data);
	} catch (e) {
